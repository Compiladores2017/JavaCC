...
//Padrao do switch
  ...
  private boolean jj_3_28() {
    if (jj_scan_token(DIGITOS_SIGNED)) return true;
    return false;
  }
  ...
  private boolean jj_3R_27() {
    ...
    if (jj_scan_token(PARENTESES_A)) return true;
    Token xsp;
    xsp = jj_scanpos;
    if (jj_3_48()) {
    jj_scanpos = xsp;
    ...
    if (jj_scan_token(PARENTESES_F)) return true;
  ...
  private boolean jj_3R_21() {
    ...
    if (jj_scan_token(VARIAVEL)) return true;
    if (jj_scan_token(PARENTESES_F)) return true;
    if (jj_scan_token(CHAVES_A)) return true;
    Token xsp;
    ...
    if (jj_scan_token(CHAVES_F)) return true;
    return false;
  }
  ...
  private boolean jj_3_27() {
    if (jj_scan_token(DIGITOS_FLUTUANTE)) return true;
    return false;
  }
  ...
  private boolean jj_3R_26() {
    ...
    if (jj_scan_token(OP_ARIT)) return true;
    xsp = jj_scanpos;
    if (jj_3_29()) {
    jj_scanpos = xsp;
    if (jj_3_30()) {
  ...
  private boolean jj_3R_28() {
    ...
    if (jj_scan_token(OP_REL)) return true;
    xsp = jj_scanpos;
    if (jj_3_21()) {
    jj_scanpos = xsp;
    if (jj_3_22()) {
  ...
  private boolean jj_3R_30() {
    if (jj_scan_token(PADRAO)) return true;
    Token xsp;
    while (true) {
      xsp = jj_scanpos;
